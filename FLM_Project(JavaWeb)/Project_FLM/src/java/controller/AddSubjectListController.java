 ...
 * @author DungNT
 */
@WebServlet(name = Constants.URL_ADDCURSUBJECT, urlPatterns = {Constants.URL_ADDCURSUBJECT})
public class AddSubjectListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/view/common/addCurriculumSubject.jsp").forward(request, response);
