 ...
 * @author NgTienDung
 */
@WebServlet(name = Constants.URL_DELETESETTING, urlPatterns = {Constants.URL_DELETESETTING})
public class DeleteSettingListController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            new SettingDao().updateStatus(id, 0);
