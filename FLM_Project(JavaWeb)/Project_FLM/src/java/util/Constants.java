...
public class Constants {
    ...
    public static final String URL_ADDSUBJECT = "/addSubject";
    ...
    public static final String URL_SYLLABUSREVIEW = "/syllabusReview";
    ...
    public static final String URL_UPLOADEXCELSESSION = "/uploadexcelsession";
    public static final String URL_SYLLABUSIMPORT = "/syllabusImport";
    public static final String URL_COMBO = "/combo";
    public static final String URL_ADDCURSUBJECT = "/addcursubject";
    public static final String URL_CURRISUBJECTLIST = "/curriculumsubjectList";
