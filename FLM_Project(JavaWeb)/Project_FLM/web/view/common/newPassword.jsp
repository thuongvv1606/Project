...
<html class="no-js" lang="zxx">
    ...
    <body>
        ...
        <main class="login-body" data-vide-bg="${pageContext.request.contextPath}/assets/img/img_6385-min.jpg">
            <!-- Login Admin -->
            <form class="form-default" action="${pageContext.request.contextPath}${Constants.URL_NEWPASSWORD}" method="POST">
                ...
                <div class="login-form">
                    ...
                    <h2 style="color: green; text-align: center;">${messSuccess}</h2>
                    <h2 style="color: red; text-align: center;">${messFail}</h2>
                    <div class="form-input">
                        <label>Email* Or Phone</label>
                        <input name="email" type="email" readonly=""required="" value="${sessionScope.email}">
                    </div>
                    <div class="form-input">
