            ...
            <section class="slider-area ">
                <div class="slider-active">
                    ...
                    <div class="single-slider slider-height d-flex align-items-center">
                        <div class="container">
                            <div class="row">
                                <div class="content-wraper features" style="background-color: white; padding: 20px; border-radius: 10px; margin: 10px">
                                            ...
                                            <c:choose>
                                                <c:when test="${item.id == 7}">
                                                    <div class="content-wraper features" style="background-color: white; padding: 20px; border-radius: 10px; margin: 10px">
                                                        ...
                                                        <a href="syllabus"><p>View Training Syllabus</p></a>
                                                        <a href="${pageContext.request.contextPath}${Constants.URL_SUBJECTPREDECESSOER}"><p>Subject Predecessors</p></a>
                                                        <a href="${pageContext.request.contextPath}${Constants.URL_SUBJECTSUCCESSOER}"><p>Subject Successors</p></a>
                                                    </div> 
                                                </c:when> 
                                                ...
                                                <c:when test="${item.id == 1}">
                                                    <div class="content-wraper features" style="background-color: white; padding: 20px; border-radius: 10px; margin: 10px">
                                                        ...
                                                        <a href="syllabusReview"><p>Review Syllabus</p></a>
                                                    </div>
                                                    <div class="content-wraper features" style="background-color: white; padding: 20px; border-radius: 10px; margin: 10px">
                                                        <h4>Designer features</h4>
                                                        <a href="syllabus?action=add"><p>Design Syllabus</p></a>
                                                    </div>
                                                    <div class="content-wraper features" style="background-color: white; padding: 20px; border-radius: 10px; margin: 10px">
                                                        ...
                                                        <a href="syllabus"><p>Manage Syllabus</p></a>
                                                    ...
                                                    <div class="content-wraper features" style="background-color: white; padding: 20px; border-radius: 10px; margin: 10px">
                                                        ...
                                                        <a href="syllabus"><p>Approve,Disapprove Syllabi</p></a> 
                                                    </div>
                                                    <div class="content-wraper features" style="background-color: white; padding: 20px; border-radius: 10px; margin: 10px">
                                                        <h4>Admin features</h4>
                                                        <a href="${pageContext.request.contextPath}/settingList"><p>System settings</p></a>
                                                        <a href="#"><p>Role Permissions</p></a>
