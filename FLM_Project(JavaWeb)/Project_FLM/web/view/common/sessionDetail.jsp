            ...
            <div class="courses-area section-padding40 fix">
                <div class="container">
                    ...
                    <c:if test="${user.roles.get(0).name eq 'System Admin' or user.roles.get(0).name  eq 'CRDD Head' or user.roles.get(0).name eq 'CRDD Staff' }">
                        <a class="btn btn-primary" href="${pageContext.request.contextPath}${Constants.URL_SESSIONEDIT}?sessionId=${listSession.getSession_id()}&syllabusId=${listSession.getSyllabus_id()}" style="color: white;margin: 10px" >Edit This Syllabus</a>
                    ...
                    <form action="${pageContext.request.contextPath}${Constants.URL_SESSIONDETAIL}" method="GET"> 
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr> 
                                    <td style="text-align: right;">ITU:</td>
                                    <td>
                                        ${listSession.getItu()}
                                    </td>
                                </tr>
