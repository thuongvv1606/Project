                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${curriculum.name.split("[(]")[1]}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: right;">English Name:</td>
                                    <td>${curriculum.name.split("[(]")[0]}</td>
                                </tr>
                                <tr> 
                                ...
                                <tr>
                                    ...
                                    <td>${curriculum.decision.decision_no}<br> (${curriculum.decision.date}) </td>
                                </tr> 
                                <tr>
                                    <td style="text-align: right;">Total credit:</td>
                                    <td>${curriculum.getTotalCredit()} </td>
                                </tr> 
                                <tr>
                                    <td style="text-align: right;">Designer:</td>
                                    <td>${curriculum.getOwner().getUserName()}</td>
                                </tr> 
                            </tbody>
                        </table>
                    </form>
