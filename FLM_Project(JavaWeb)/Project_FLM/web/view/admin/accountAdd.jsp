...
<html class="no-js" lang="zxx">
    ...
    <body>
        ...
        <div class="section-tittle text-center">
            <h2 style="margin-top: 20px;">Add Account</h2>
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="account" method="POST">
                                <div class="row">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <div>
                                            <input class="form-control" name="fullname" type="text" placeholder="Enter fullname" value="${fullname}" required=""
                                        ...
                                        <div>
                                            <input class="form-control" name="phone" type="text" placeholder="Enter phone number" value="${phone}"
                                        ...
                                        <div>
                                            <input class="form-control" name="company" type="text" placeholder="Enter company" value="${company}"
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <div>
                                            <input class="form-control" name="username" type="text" placeholder="Enter username" value="${username}"
                                        ...
                                        <div>
                                            <input class="form-control" name="email" type="text" placeholder="Enter email address" value="${email}"
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <c:forEach items="${rList}" var="r">
                                            <input name="role" type="checkbox" value="${r.getId()}" ${r.getId() == 1 ? "checked" : ""}> ${r.getName()}<br>
                                        </c:forEach>
                                    </div>  
                                    <div class="col-12">
                                        <div class="text-end">
                                            <button type="submit" name="save" class="btn btn-primary" style="margin-bottom: 5px;">Add Account</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
