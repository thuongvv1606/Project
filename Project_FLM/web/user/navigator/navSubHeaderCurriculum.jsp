            ...
            <nav class="navbar navbar-expand-lg " style="justify-content: space-between" id="navbar">
                <div class="collapse navbar-collapse" id="navbarNavDropdown" style="flex-grow: 0; margin: auto">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}${Constants.URL_PLOLIST}?curriculum_id=${curriculum.curriculumID}">PLOs</a>
                        
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">PLO-Pos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="contentgroup?action=list&&curId=${curriculum.curriculumID}">Content Group List</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">Map PLO-PO</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}${Constants.URL_SUBJECTLIST}?idCurrent=${requestScope.curriculum.curriculumID}">Subject List</a>
                        </li>
                        <li class="nav-item">
