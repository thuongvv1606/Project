                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="name" id="code" required="" type="text" value="${listSession.getName()}" placeholder="Enter Name">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea id="description"
                                      ...
                                      rows="6"
                                      required=""
                                      >${listSession.getDetails()}</textarea>
<!--<input class="form-control" name="description" id="Description" type="text" value="${detail}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Subject'" placeholder="Enter Name">-->
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="syllabus_id" id="total" required="" type="text" value="${listSession.getSyllabus_id()}" placeholder="Enter Curriculum">

                        </div>
                    </div>
                    <div class="col-12">
                        <label>Learning type</label>
                        <input class="form-control" name="learning" id="total" required="" type="text" value="${listSession.getLearning_type()}" placeholder="Enter Curriculum">

                    </div>
                    <div class="col-12">
                        <label>Student materials</label>
                        <input class="form-control" name="materials" id="total" required="" type="text" value="${listSession.getStudent_materials()}" placeholder="Enter Curriculum">

                    </div>
                    <div class="col-12">
                        <label>Student task</label>
                        <input class="form-control" name="task" id="total" required="" type="text" value="${listSession.getStudent_task()}" placeholder="Enter Curriculum">
                ...
                <div class="form-group mt-3">
                    <button type="submit" name="add" onclick="activeErrorToast(${mess});" value="Add" class="button button-contactForm boxed-btn">Save</button>
                </div>
            </form>
        </div>
        <!--Start Footer-->
