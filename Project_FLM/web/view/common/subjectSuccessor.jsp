...
<html>
    ...
    <body>
        ...
        <div class="section-tittle text-center">
            <h2 style="margin-top: 20px;">Subject Successor</h2>
        </div> 

        <div style="height: 500px">
            <form action="${pageContext.request.contextPath}${Constants.URL_SUBJECTSUCCESSOER}" method="POST">
                <div class="row" style="padding: 20px; display: flex;">
                    <div style="margin: auto;">

                        <h1>A subject is the pre-requisite of</h1>
                    ...
                    <table class="table table-striped table-hover" style="background-color: #f9f9ff">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>${s.getName()}</td>
                                <td>${s.getDecision().getDecision_no()} ${s.getDecision().getDecision_date() }</td>
                                    ...
                                    <td><b>*${s.getSubject().getCode()} :</b>
                                        <c:forEach items="${s.getPre()}" var="pr" varStatus="loop">
                                            ...
                                            <c:forEach items="${s.getPre()}" var="pr">
                                                ...
                                                <c:if test="${b.getSubject().getId()  == pr.getSubjectId()}">
                                                    <p><b>-${pr.getCode()}:</b>
