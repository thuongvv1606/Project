                    ...
                    <form class="form-default" action="${pageContext.request.contextPath}${Constants.URL_UPDATEUSERPROFILE}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="fullname" pattern="${Constants.HTML_REGEX__FULLNAME}" 
                               ...
                               title="${Constants.HTML_TITLE_OF_REGEX__FULLNAME}" type="text" value="${user.getFullName()}" placeholder="Enter your full name" >
                        </div>
                        <!-- Form Row-->
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" name="company" type="text" value="${user.getCompany()}" placeholder="Enter your Company" >
                            </div>
                            <!-- Form Group (location)-->
                            <div class="col-md-6">
                        ...
                        <div class="mb-1">
                            ...
                            <input class="form-control" name="email" type="email" pattern="${Constants.HTML_REGEX_EMAIL}" 
                               title="${Constants.HTML_TITLE_OF_REGEX__EMAIL}"
                                   placeholder="Enter your email address" value="${user.getEmail()}">
                        </div>
                        <!-- Form Row-->
                        <div class="row gx-3 mb-3">
