                                        ...
                                        <ul id="navigation">
                                            <c:if test="${sessionScope.user != null}">
                                                ...
                                                <c:if test="${sessionScope.user.getRoleFunction() != null}"> 
                                                    <c:if test="${sessionScope.user.getRoleFunction() == 0}"> 
                                                        ...
                                                        <!--sysllabus designer , reviewer navbar-->
                                                        <c:if test="${sessionScope.user.getRoleFunction() == 1}">
                                                        <li><a href="curriculum">Curriculum</a></li>
                                                        <li><a href="${pageContext.request.contextPath}${Constants.URL_SUBJECTPREDECESSOER}">Subject Predecessors</a></li>
                                                        <li><a href="${pageContext.request.contextPath}${Constants.URL_SUBJECTSUCCESSOER}">Subject Successors</a></li> 
                                                        <li><a href="#">Dashbroad</a>
                                                            <ul class="submenu">
                                                                <li><a href="#">Syllabus Designing</a></li>
                                                            </ul>
                                                        </c:if>
