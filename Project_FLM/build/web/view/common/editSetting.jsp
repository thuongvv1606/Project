                                        ...
                                        <div class="row">
                                           ...
                                           <div class="form-group col-6">
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <div> 
                                                    <input ${setting.status == 1 ?'checked':''}   type="radio" name="status" id="s1"  value="1"/> 
                                                    <label for="s1">Active</label> 
                                                    <input ${setting.status == 2 ?'checked':''}  type="radio" name="status" id="s2"  value="2"/> 
                                                    <label for="s2">Block</label> 
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="text-end">
