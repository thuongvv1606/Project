            ...
            <div class="courses-area section-padding40 fix">
                <div class="container">
                    ...
                    <c:if test="${user.roles.get(0).name eq 'System Admin' or user.roles.get(0).name  eq 'CRDD Head' or user.roles.get(0).name eq 'CRDD Staff' }">
                        <a class="btn btn-primary" href="#" style="color: white;margin: 10px" >Edit This Syllabus</a>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${syllabus.getDecision().getDecision_no()}<br> ${syllabus.getDecision().getDecision_date()} </td>
                                </tr> 
                                <tr> 
                                    <td style="text-align: right;">Status:</td>
                                    <td>
                                        ${syllabus.getStatus() ? "Active" : "Dormant"}
                                    </td>
                                </tr>
                                <tr> 
